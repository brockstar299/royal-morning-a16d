...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/royal-morning-a16d)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/royal-morning-a16d
```

A live public deployment of this template is available at [https://royal-morning-a16d.templates.workers.dev](https://royal-morning-a16d.templates.workers.dev)
